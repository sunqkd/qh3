		...
		<div class="homeBody">
			...
			<div class="roadProject">
				<ul>
					...
					<li>
						公司是一家超微量肿瘤液体活检企业，主要业务包括癌症基因检测和健康人群基因检测，核心技术是超微量肿瘤液体活检。基于以液体活检、基因测序、人工智能等技术和数据分析方法，为肿瘤的病前、病中、病后提供精准的基因组学诊断方案和全程管理方案。
					</li>
					<li>投资亮点：</li>
			...
			<div class="roadProject">
				<ul>
					<li>路演项目五：心血管领域诊断设备研发商</li>
					<li>
						公司是专注于研发心血管疾病精准诊断与治疗性医疗器械的高科技企业，主要从事诊断、治疗心血管疾病医疗设备产品研发、生产、销售及售后服务，主要产品包括CTA图像后处理软件、冠脉斑块诊断仪、FFR—球囊导管等。
					</li>
					<li>投资亮点：</li>
					<li class="disc">董事长为青年千人计划获得者，深港产学研基地心血管影像与介入医疗器械工程实验室主任。长期从事心血管生物力学、无创诊断方法和介入医疗器械的研究工作。</li>
					<li class="disc">公司拥有独立自主的医疗器械系统研发实力，并已获得 20 余项心血管诊断领域相关的专利，与多家医疗机构展开临床科研合作并获得专家的认可。</li>
				</ul>
			</div>

			<div class="roadProject">
				<ul>
					<li>路演项目六：医用物资管理方案提供商</li>
					<li>
			...
			<div class="tableContain">
				<!-- 剩余报名人数 -->
				<div class="residue">
					剩余报名名额：{{208 - tableList.length >= 0? 208 - tableList.length:0}}
				</div>
