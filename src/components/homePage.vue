<template>
	<div class="homePage">
		...
		<div class="homebg">
			...
			<img src="./img/titleName.png" alt="" class="homeText wow animated bounce">
			<!-- 单位 -->
			<div class="unit">
		...
		<div class="homeBody">
			...
			<div class="judge">
				...
				<img src="./img/time2.png"  alt="" style="margin-bottom:32px">
				<img src="./img/time3.png"  alt="" style="margin-bottom:32px">
				<img src="./img/time4.png"  alt="" style="margin-bottom:32px">
			...
			<div class="roadProject">
				<ul>
					<li>路演项目一：CAR-T免疫疗法与纳米抗体生物药研发商</li>
					<li>
						公司以CAR-T细胞免疫治疗和纳米抗体生物药研发为主要发展方向，分别在北京和深圳建有研发、生产基地及羊驼养殖基地的国家高新技术企业。
					</li>
					<li>投资亮点：</li>
			...
			<div class="roadProject">
				<ul>
					<li>路演项目二：创新药物及生物标记物研发商</li>
					<li>
						公司是一家面向国内外市场，产学研一体化的，从事创新药物以及生物标记物的科研、开发和商业化的企业。
					</li>
					<li>投资亮点：</li>
					<li class="disc">目前已经上市I类新药一个，医疗器械（含体外诊断试剂）产品3个，在研创新产品20余项。其中I类新药“依叶”是我国过去6年批准上市的心血管系统唯一的国家I类（化学）新药；2010年被列入国家重大专项重大战略新品种（全国一共5项，广东省唯一的一项）。</li>
					<li class="disc">完成或正在承担国家重大新药创制、863、973、国家自然科学基金、省部级项目20余项，以及美国NIH资助的10多项国际合作项目。</li>
					<li class="disc">团队研发实力强，迄今已经在国际专业杂志上发表了300余篇SCI论文，影响因子超过1000分；申请专利178项，其中授权专利61。</li>
				</ul>
			</div>
			<div class="roadProject">
				<ul>
					<li>路演项目三：全血压软硬件整合解决方案供应商</li>
					<li>
						公司是一家主要从事医疗器械研发、生产、销售及移动健康管理服务等业务的高新技术企业，主要产品有新一代脉搏波血压计、激光医疗器械、血压云健康管理系统等。
					</li>
					<li>投资亮点：</li>
					<li class="disc">董事长清华大学吴小光博士是我国最早做电子血压计的代表性人物，也是脉搏波测量技术的发明人，团队技术优势领先。CEO从事医疗器械销售及管理工作20余年，多个医疗器械企业成功操盘经验。</li>
					<li class="disc">脉搏波法血压计为公司独家产品，准确度媲美“金标准”水银血压计，可作为医用血压测量仪器，已成为国产医疗院线第一品牌。</li>
					<li class="disc">本年度营收较上一年增加60%，公司业绩正处于高速成长期。</li>
				</ul>
			</div>
			<div class="roadProject">
				<ul>
					<li>路演项目四：超微量肿瘤液体活检研发商</li>
					<li>
						公司是一家超微量肿瘤液体活检企业，主要业务包括癌症基因检测和健康人群基因检测，核心技术是超微量肿瘤液体活检。
					</li>
					<li>投资亮点：</li>
					<li class="disc">公司已投资数亿元引进全球最先进的Illumina NovaSeq6000、HiSeq X Ten、NextSeq500/550系列测序平台和数字PCR平台，成功打造了全球顶级基因检测中心。</li>
					<li class="disc">目前，公司测序通量全球第二，肿瘤基因数据产出量居全国前列，业务覆盖30多个省份300+顶级三甲医院。</li>
					<li class="disc">聚焦肿瘤精准诊疗，在基因测序、液体活检、生物信息和大数据等领域具有独创技术和核心优势，液体活检等技术获得深圳市重大科技创新突破。</li>
				</ul>
			</div>
			<div class="roadProject">
				<ul>
					<li>路演项目五：生物3D打印设备的行业颠覆者</li>
					<li>
						公司专注于生物3D打印领域，产品范围覆盖设备、耗材、成品三大方面，包括光固化生物3D打印机、相关耗材，及其高拟真皮肤、功能性肝单元、干细胞微球等组织3D打印产品。
					</li>
					<li>投资亮点：</li>
					<li class="disc">3D打印装备 开发方面实现了突破型创新，将传统生物3D打印的效率与精度提升至10倍以上，冲击世界顶尖水平。</li>
					<li class="disc">公司产品已具备商业化落地的雏形，国内生物3D打印企业少有。</li>
				</ul>
			</div>

			<div class="roadProject">
				<ul>
					<li>路演项目六：医疗器械及设备研发商</li>
					<li>
						公司致力于腹腔镜手术创新技术的开发和商业化应用，并期望成为值得尊敬和信赖的全球性领军企业。
					</li>
					<li>投资亮点：</li>
					<li class="disc">创始及顾问团队拥有超过35年的顶级外科公司经验，成员为英国皇家艺术与设计学院院士和英国卫生部顾问。</li>
					<li class="disc">所有产品均有专利授权，创新性的系统能够降低手术难度，节省手术时间，提高手术精度。</li>
				</ul>
			</div>

			<div class="roadProject">
				<ul>
					<li>路演项目七：消费级动力外骨骼研发商</li>
					<li>
						公司是一家消费级动力外骨骼研发商，致力于开发新一代智能动力外骨骼产品，帮助解决数以千万计的行走障碍患者的医疗与康复问题，提高生活品质。
					</li>
					<li>投资亮点：</li>
					<li class="disc">公司创始人团队源自于美国德州大学的医疗外骨骼研发团队，有多年的医疗机器人设计，制造与临床应用的经验与行业资源背景。</li>
					<li class="disc">国内第一款可商业化的轻量化外骨骼。</li>
					<li class="disc">我国的老龄化带来的下游客户需求很大，我国每年发生康复服务的次数有 2 亿多次，预计三年内会增加到 5 亿次。</li>
				</ul>
			</div>
			<div class="roadProject">
				<ul>
					<li>路演项目八：SPD智慧型医用物资管理服务商</li>
					<li>
						公司是一家专门从事医院物资管理建设和服务，全面推动医院物资管理向智慧型和区域型SPD发展的医院物资管理建设和运营服务的平台商。
					</li>
					<li>投资亮点：</li>
					<li class="disc">创始人为国内管理服务模式SPD 创始人，医院一线深入调研多年，充分了解行业痛点。</li>
					<li class="disc">拥有SPD院内物流精细化管理系统、供应采购协同商务平台、手术室术式套包管理系统、资质证照管理系统、智能柜系统等多项自主知识产权产品。</li>
					<li class="disc">先后荣获2016-2017年度医药供应链“金质奖”十佳创新价值企业奖，2018世界智能大会首届全国智慧医疗大赛“十大创新企业”奖，2018智慧医疗创新大赛“优胜奖”等多项荣誉。</li>
				</ul>
			</div>
			<div class="roadProject">
				<ul>
					<li>路演项目九：创新仿制药生产商</li>
					<li>
						公司是一家以快速有效方式引进创新性新药并迅速商业化的新型生物制药企业
					</li>
					<li>投资亮点：</li>
					<li class="disc">拥有国内第一条纳米乳注射剂生产线（美国成熟技术引进），国内第二条高标准凝胶膏生产线。</li>
					<li class="disc">与多家北美地区的生物制药企业签订了战略合作伙伴协议，已引进多个填补国内空白的高端制剂平台，拥有多个基于505b2方式获批的创新药的中国权益，并将通过自身优秀的商业化能力迅速形成销售规模。</li>
				</ul>
			</div>
			<div class="roadProject">
				<ul>
					<li>路演项目十：肿瘤诊疗信息化方案提供商</li>
					<li>
						公司是一家肿瘤诊疗信息化方案提供商，专注于肿瘤放射治疗临床技术开发、应用与面向基层科室建设、医患服务、实现放疗技术普及的高科技公司，也是国内放疗领域信息化技术、远程放疗技术服务与AI应用的开拓者与领导者。
					</li>
					<li>投资亮点：</li>
					<li class="disc">国内唯一突破国外技术壁垒，掌握各品牌加速器数据接口技术的公司，解决了肿瘤放疗数据无法共享，临床数据难以回顾分析的痛点。</li>
					<li class="disc">聚焦肿瘤放射治疗领域15年，400余家（70%为三甲医院） 一线放疗中心临床用户、100余项相关知识产权、国内放疗信息化及服务产业的开拓者。</li>
					<li class="disc">与301医院、中山大学肿瘤医院、清华大学等为代表的顶级院校深度合作，拥有千人规模的专家团队，与人工智能独角兽商汤科技达成在放疗领域的独家战略合。</li>
				</ul>
			</div>
			...
			<div class="tableContain">
				<!-- 剩余报名人数 -->
				<div class="residue">
					剩余报名名额：{{238 - tableList.length >= 0? 238 - tableList.length:0}}
				</div>
...
export default {
	data () {
		return {
			...
			title:'【邀请函】2019中国精准医疗高峰论坛暨医疗健康专场路演@国际路演中心',
			decs:'智汇全球·追梦前海 活动时间：12月20日9:00 活动地点：前海深港青年梦工场>>',
